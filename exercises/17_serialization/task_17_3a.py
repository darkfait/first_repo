...
file_list = ['sh_cdp_n_sw1.txt','sh_cdp_n_r1.txt','sh_cdp_n_r2.txt','sh_cdp_n_r3.txt','sh_cdp_n_r4.txt','sh_cdp_n_r5.txt','sh_cdp_n_r6.txt']
        
if __name__ == "__main__":
    generate_topology_from_cdp(file_list, save_to_filename ='topology.yaml')
