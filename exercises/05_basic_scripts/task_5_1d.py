...
dev1=input('Введите имя устройства:  ')
parm_list=','.join(london_co[dev1].keys())
Parm_to_print = london_co[dev1].get(input('Введите имя параметра  ('+ parm_list + ')  :').lower(),'Такого параметра нет')
print(Parm_to_print)
